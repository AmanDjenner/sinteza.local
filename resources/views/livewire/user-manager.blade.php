<div>
        ...
        <table class="w-[70%] bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700">
            <thead>
                <tr>
                    ...
                    <th class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">Email</th>
                    <th class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">Email Verificat</th>
                    <th class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">Instituție</th>
                    <th class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">Creat</th>
                    <th class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">Actualizat</th>
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr>
                        <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">{{ $user->name }}</td>
                        <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">{{ $user->email }}</td>
                        <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">{{ $user->email_verified_at ? $user->email_verified_at->format('d-m-Y H:i') : 'Ne-verificat' }}</td>
                        <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">{{ $user->institution ? $user->institution->name : 'Fără instituție' }}</td>
                        <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">{{ $user->created_at->format('d-m-Y H:i') }}</td>
                        <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white">{{ $user->updated_at->format('d-m-Y H:i') }}</td>
    ...
    <div class="fixed inset-0 bg-black flex justify-center items-center">
        <div class="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg w-1/2 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-700">
            <h2 class="text-xl mb-4">{{ $editingUserId ? 'Editează utilizator' : 'Crează utilizator' }}</h2>
