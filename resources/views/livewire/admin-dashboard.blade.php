<div>
        ...
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
            <li class="me-2">
                <button wire:click="setTab('users')" 
                    ...
                    <svg class="w-4 h-4 me-2 {{ $activeTab === 'users' ? 'text-blue-600 dark:text-blue-500' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li class="me-2">
                <button wire:click="setTab('roles')" 
                    ...
                    <svg class="w-4 h-4 me-2 {{ $activeTab === 'roles' ? 'text-blue-600 dark:text-blue-500' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
            ...
            <li class="me-2">
                <button wire:click="setTab('permissions')" 
                    ...
                    <svg class="w-4 h-4 me-2 {{ $activeTab === 'permissions' ? 'text-blue-600 dark:text-blue-500' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M5 11.424V1a1 1 0 1 0-2 0v10.424a3.228 3.228 0 0 0 0 6.152V19a1 1 0 1 0 2 0v-1.424a3.228 3.228 0 0 0 0-6.152ZM19.25 14.5A3.243 3.243 0 0 0 17 11.424V1a1 1 0 0 0-2 0v10.424a3.227 3.227 0 0 0 0 6.152V19a1 1 0 1 0 2 0v-1.424a3.243 3.243 0 0 0 2.25-3.076Zm-6-9A3.243 3.243 0 0 0 11 2.424V1a1 1 0 0 0-2 0v1.424a3.228 3.228 0 0 0 0 6.152V19a1 1 0 1 0 2 0V8.576A3.243 3.243 0 0 0 13.25 5.5Z"/>
                    </svg>Permisiuni
                </button>
            </li>
            <li class="me-2">
                <button wire:click="setTab('institutions')" 
                    ...
                    <svg class="w-4 h-4 me-2 {{ $activeTab === 'institutions' ? 'text-blue-600 dark:text-blue-500' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                        <path d="M16 1h-3.278A1.992 1.992 0 0 0 11 0H7a1.993 1.993 0 0 0-1.722 1H2a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2Zm-3 14H5a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2Zm0-4H5a1 1 0 0 1 0-2h8a1 1 0 1 1 0 2Zm0-5H5a1 1 0 0 1 0-2h2V2h4v2h2a1 1 0 1 1 0 2Z"/>
                    </svg>Instituții
                </button>
            </li>
            <li class="me-2">
                <button wire:click="setTab('event-categories')" 
                    ...
                    <svg class="w-4 h-4 me-2 {{ $activeTab === 'event-categories' ? 'text-blue-600 dark:text-blue-500' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M5 1a2 2 0 0 0-2 2v1h14V3a2 2 0 0 0-2-2H5ZM3 6V5h14v1H3Zm0 3h14v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9Zm4 2v6h6v-6H7Z"/>
                    </svg>Categorii Evenimente
                </button>
            </li>
        </ul>
    </div>
    ...
    @elseif ($activeTab === 'injuries')
        <livewire:injury-manager />
    @endif
    </div>
</div>