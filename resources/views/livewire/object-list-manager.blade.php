        ...
        <table class="w-full bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-sm">
            <thead>
                <tr>
                    ...
                    <th class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-left">Nume</th>
            ...
            <tbody>
                @forelse ($objectLists as $index => $objectList)
                    <tr>
                        <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-center">{{ $index + 1 }}</td>
                        <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-left">{{ $objectList->name }}</td>
